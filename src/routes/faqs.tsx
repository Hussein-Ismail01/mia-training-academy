  ...
  head: () => ({
    meta: [
      { title: "FAQs | Admissions, Tuition & Academics at MIA" },
      {
        name: "description",
        content:
          "Answers on MIA Training Academy admissions, tuition and payment plans, academics, campus life and online learning.",
      },
      { property: "og:title", content: "Frequently Asked Questions | MIA Training Academy" },
      {
        property: "og:description",
        content: "Search answers about admissions, fees, academics, campus life and online study.",
      },
    ],
  }),
  component: FaqsPage,
