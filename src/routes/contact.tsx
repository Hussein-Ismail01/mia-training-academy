...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact MIA Training Academy | Maadi, Cairo" },
      {
        name: "description",
        content:
          "Reach the MIA Training Academy team in Maadi, Cairo. Send a message, call an advisor or book a 15-minute discovery call.",
      },
      { property: "og:title", content: "Contact MIA Training Academy" },
      {
        property: "og:description",
        content: "Address, phone, email, office hours and advisor bookings.",
      },
    ],
  }),
      ...
      <section aria-labelledby="map-heading" className="bg-surface py-20">
        <div className="container-page">
          ...
          <Reveal className="overflow-hidden rounded-3xl border border-border shadow-soft">
            <iframe
              title="MIA Training Academy location in Maadi, Cairo"
